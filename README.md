...
- **제작 기간:** 2026.06.09(Tue) ~ 2026.06.14(Sun) (40시간)
- **최종 결과물 요약:**
...
## 🛠️ 2. AI 아키텍처 및 파이프라인 (AI Tool Pipeline)
...
**무료 제한:**
* Flow: 매일 50 AI 크레딧을 제공. Omni Flash의 무료 버전은 Start이미지만 넣을 수 있음. `Veo 3.1 Lite`는 무료 버전에서도 Start와 End이미지 모두 삽입 가능. 비디오 생성에서 [프레임, 16:9, Omni Flash, 6s] 조합으로 10 크레딧 소모. 하루 크레딧을 모두 소모하면 다른 이메일 계정 사용함. (Runway Gen-3는 유료 버전으로 안내해서 사용 안 함)
